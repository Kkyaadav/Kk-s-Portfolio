  ...
  return (
    <section id="home" className="pt-20 pb-16 px-4 sm:px-6 max-w-screen-xl mx-auto text-center relative min-h-screen flex flex-col justify-center items-center bg-black">
      ...
      >
        ...
        <motion.h1
          variants={fadeUp}
          className="p-2 text-5xl md:text-7xl font-saccra font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 animate-gradient-x tracking-tight"
        >
          Kailash Kumar
        </motion.h1>
